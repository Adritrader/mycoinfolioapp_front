      ...
      <section class="card border shadow mt-3">
                    <div class="row p-3">
                        ...
                        <div class="col-8">
                            ...
                            <p class="fecha-entrada"><i class="fas fa-calendar"></i>&nbsp;Published on: <span></span><span class="mx-5 px-3 bg-primary"></span></p>
                            <p class="texto-entrada">{ data.content }</p>

                            <div class="row d-flex">
                              <div className="col-6">
                                <a href=""><button class="btn btn-dark mx-1">Reply</button></a>
                                <a href={data.id+"/analysis"}><button class="btn btn-info mx-1">Show</button></a>
                                </div>
                            </div>
